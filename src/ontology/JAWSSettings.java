...
public class JAWSSettings 
{
    ...
    public String toJSON()
    {
        ...
        /*result = result + tmpGson.toJson(OtherSettings_ResearchIt) + "\n";
        result = result + tmpGson.toJson(OtherSettings_TextAnalyzer) + "\n";
        result = result + tmpGson.toJson(OtherSettings_ConventientOCR) + "\n";
        result = result + tmpGson.toJson(OtherSettings_Miscellaneous_SleppMode) + "\n";
        result = result + tmpGson.toJson(OtherSettings_Miscellaneous_SearchForPrompts) + "\n";
        result = result + tmpGson.toJson(OtherSettings_Miscellaneous_UseVirtualRibbonMenu) + "\n";
        result = result + tmpGson.toJson(OtherSettings_Miscellaneous_UseVirtualPCCursor) + "\n";
        result = result + tmpGson.toJson(OtherSettings_Miscellaneous_TrackFocusRectanle) + "\n";
        result = result + tmpGson.toJson(OtherSettings_Miscellaneous_TextOutDelay) + "\n";
        result = result + tmpGson.toJson(OtherSettings_Miscellaneous_PixelsPerSpace) + "\n";
        result = result + tmpGson.toJson(OtherSettings_Miscellaneous_PixelsPerTab) + "\n";
        result = result + tmpGson.toJson(OtherSettings_Miscellaneous_LeftMargin) + "\n";
        result = result + tmpGson.toJson(OtherSettings_Miscellaneous_UnderlineProximity) + "\n";
        result = result + tmpGson.toJson(OtherSettings_Miscellaneous_ClickTolerance) + "\n";
        result = result + tmpGson.toJson(OtherSettings_Miscellaneous_RelyOnMSAA) + "\n";
        result = result + tmpGson.toJson(OtherSettings_Miscellaneous_MSAAMode) + "\n";
        result = result + tmpGson.toJson(PlaceMarkers) + "\n";
        result = result + tmpGson.toJson(ConfigurationFilesExtension) + "\n";
        result = result + tmpGson.toJson(DictionaryFilesExtension) + "\n";
        result = result + tmpGson.toJson(GraphicLabelFilesExtension) + "\n";
        result = result + tmpGson.toJson(KeyboardMappingFilesExtension) + "\n";
        result = result + tmpGson.toJson(BrailleSettingFilesExtension) + "\n";
        result = result + tmpGson.toJson(SpeechAndSoundSchemeFilesExtension) + "\n";
        result = result + tmpGson.toJson(ScriptSourceFilesExtension) + "\n";
        result = result + tmpGson.toJson(ScriptCompiledSourceFilesExtension) + "\n";
        result = result + tmpGson.toJson(ScriptMessagesFilesExtension) + "\n";
        result = result + tmpGson.toJson(ScriptHelpFiles) + "\n";*/
